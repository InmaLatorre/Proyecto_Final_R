...
<center margin: auto>![Vista previa de r4ds](r4ds.png){width=70%}</center>
<div/>


- _Contenido:_ Estructurado y extenso. Para un aprendizaje en mayor profundidad de su uso. Buen material para aprneder cosas más allá de un documento básico.
- _Código:_ Muy bueno. Muestra a propósito código en la parte instructora, pero no lo hace en las partes que no es necesario.
- _Estética:_ Docente. Siguiendo la estructura de un libro académico, no se excede en florituras innecesarias.

##

<div style="text-align: justify">
**CONCLUSIÓN:** RStudio es muy buen recurso para, de un vistazo, poder saber lo básico que alcanza un documento RMarkdown. Sin embargo, si lo que se quiere es un conocimiento más profundo, es mejor recurrir a r4ds. <div/>
...
La media de peso el día del nacimiento de los pollitos fue 41.06 gramos. La media de peso el último día que se tomaron datos, el 21, fue de 218.69 gramos.
...
<span style="color:white">Pongo esta línea en blanco para ganar espacio entre el gráfico por facetas y el texto que lo analiza</span>
...
Observamos que la Dieta 3 es la más pesada, provocando que los pollitos que siguen dicha dieta tengan una tendencia mayor a engordar.  
